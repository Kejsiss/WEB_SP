...
class MyDatabase {
    ...
    public function getAllRights(){
        ...
        $rights = $this->selectFromTable(TABLE_PRAVO, "", "vaha DESC, nazev DESC");
        return $rights;
    }
    ...
    public function addNewUser(string $login, string $heslo, string $jmeno, string $prijmeni, string $email, int $idPravo = 4){
        ...
        $insertStatement = "username, heslo, jmeno, prijmeni, email, id_PRAVO";
    ...
    public function updateUser(int $idUzivatel, string $login, string $heslo, string $jmeno, string $prijmeni, string $email, int $idPravo){
        ...
        $updateStatementWithValues = "username='$login', heslo='$heslo', jmeno='$jmeno', prijmeni='$prijmeni', email='$email', id_pravo='$idPravo'";
        // podminka
    ...
    public function userLogin(string $login, string $heslo){
        ...
        $where = "username='$login' AND heslo='$heslo'";
